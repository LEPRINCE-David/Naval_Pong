...
THREE.ShaderLib['water'] = {
  ...
  vertexShader: [
    ...
    'void main()',
    '{',
    '  mirrorCoord = modelMatrix * vec4(position, 1) * 1.99;', // 1.99 to closer mirror-shadow
    ...
    '  mirrorCoord = textureMatrix * mirrorCoord * 1.99;', // 1.99 to closer mirror-shadow
